try:
    from shared.utils import fetch_fmi_data, fetch_hourly_one_day,  upload_weather_data, calculate_daily_from_hourly
except Exception as e:
    logging.warning(e)
    from utils import fetch_fmi_data, fetch_hourly_one_day,  upload_weather_data, calculate_daily_from_hourly
